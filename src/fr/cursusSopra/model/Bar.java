...
public class Bar {
	...
	public List<BarEvaluation> getLstEvals() {
		...
		Connection cnx = PostgresConnection.GetConnexion();
		String query = "SELECT libcourt, liblong, note from v_evalbar WHERE idbar = ? ORDER BY tri";
		PreparedStatement ps=null;
		try {
			ps = cnx.prepareStatement(query);
			ps.setInt(1, idBar);
	...
	public void razCritere() {
		Connection cnx = PostgresConnection.GetConnexion();
		String query = "DELETE FROM criteresbars WHERE idbar = ?";
		PreparedStatement ps = null;
		try {
			ps = cnx.prepareStatement(query);
			ps.setInt(1, idBar);
	...
	public void razHoraires() {
		Connection cnx = PostgresConnection.GetConnexion();
		String query = "DELETE FROM horaires WHERE idbar = ?";
		PreparedStatement ps = null;
		try {
			ps = cnx.prepareStatement(query);
			ps.setInt(1, idBar);
