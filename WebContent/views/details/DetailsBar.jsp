		...
		<div class="col-md-7" >
			<div class="panel panel-primary">
				<div class="panel-heading" style="text-align:center">
						...
						<b><font size="20px" face="Mistral" >
						<s:property value="leBar.nom.toUpperCase()"/>
						</font></b>
					
					   <img src="<s:property value="leBar.lienImage"/>" width="40%" height="40%"/>

					
				</div>
				<div class="panel-body">
					<h3>L'avis de <font face="Comic Sans">GlouGlouBar</font> </h3><br/>
					<s:property value="leBar.description"/> <br/>
				</div>
				<div class="panel-body">
					...
					<s:if test="%{leBar.lstHoraires.size > 0}">						
						<table class="table table-striped table-hover" style="text-align:center;">					
							<thead>
								<tr>
									<th colspan="2" style="text-align:center;">Horaires d'ouverture</th>
								</tr>
							</thead>
							<tbody>
					...
					<a href="<s:property value='#GoToformEval'/> "> Donnez votre avis </a>
				</div>
			</div>
		</div>
		<div class="col-md-3" >
			<div class="panel panel-info" style="margin-right:20px;">
				...
				<div class="panel-body">
					<s:property value="leBar.nom"/><br/>
					<s:property value="leBar.voie"/><br/>
					<s:property value="leBar.cp"/>
					<s:property value="leBar.ville"/><br/>
					<br/>
					<s:property value="leBar.numTel"/><br/>
					<br/>
					<s:property value="leBar.site"/><br/>
				</div>
			</div>
		</div>
	</div>
...
<div class="row">
		...
		<div class="col-md-7">
			<div class="panel panel-info">
				<div class="panel-heading" style="text-align:center">
				<h2>Votre avis sur <s:property value="leBar.nom"/></h2>
				</div>
				<div class="panel-body">
